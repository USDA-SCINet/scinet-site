...
![](/assets/img/events/bioinfo/genomescope-1.png) 
![](/assets/img/events/bioinfo/genomescope-2.png) 
...
module purge 
module load hifiasm 
time hifiasm -o 06_Assembly/chr2_hifi.asm -t 8 -m 10 01_Data/AT_HiFi_chr2.fastq.gz 
...
time compleasm run -t 8 \ 
  -l eukaryota -L 01_Data/busco_downloads/lineages/embryophyta_odb12/ \ 
