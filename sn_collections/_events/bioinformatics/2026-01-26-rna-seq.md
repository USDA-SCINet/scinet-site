...
For this workshop, we will import data via a shared Galaxy history that we created prior to the workshop.  
Here is [the link to a Galaxy history with all the files needed for the workshop](https://galaxy.scinet.usda.gov/u/lavidarogers/h/galaxy-workshop-files-1).
...
In this session, we will show how to create a workflow for the **RNA-seq data from an Arabidopsis mutant and wild-type (WT)** that we have covered so far.
...
From this point onward, RNA-seq becomes a gene-level counting problem.
