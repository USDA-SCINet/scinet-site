...
### Building Galaxy workflows

Next, we will show how to create a workflow for our analysis of RNA-seq data from *Arabidopsis* mutant and wild-type (WT) samples.

Our biological question is simple:

*Which genes are expressed differently between mutant and WT plants?*

To answer this, we follow a standard RNA-seq strategy:
...
This workflow focuses on core analysis.
...
These steps are conceptually parallel to the main analysis
and are often handled separately for clarity.
