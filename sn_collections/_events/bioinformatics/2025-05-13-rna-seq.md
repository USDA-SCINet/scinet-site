...
cp –p /project/scinet_workshop2/Bioinformatics_series/wk3_workshop/day1/DESeq2.R .
```
-----
...
For this tutorial, the steps below are is optional.
```bash
mkdir 00_Genome
cd 00_Genome
...
The reads for this demonstration are from https://www.ebi.ac.uk/ena/browser/view/SRX9312090 
We will use **BBDUK:** Decontamination using kmers (https://archive.jgi.doe.gov/data-and-tools/software-tools/bbtools/bb-tools-user-guide/bbduk-guide/) 

```bash 
FFPE=“/project/scinet_workshop2/Bioinformatics_series/wk3_workshop/day1/FFPE” 
...
GENOME_DIR = /project/scinet_workshop2/Bioinformatics_series/wk3_workshop/day1/00_Genome/ 

 

`{ time hisat2-build -p8 $GENOME_DIR/GCF_000001735.4_TAIR10.1_genomic.fna 02_Hisat2/Arabidopsis_TAIR10.1 >& hs2build.log; } 2> hs2build.time &` 
...
We have saved the entire R script for DESeq2 (`DESeq2.R`). The script is partly based on Stephen Turner's template from https://gist.github.com/stephenturner/f60c1934405c127f09a6. We have displayed R script here largely for reference 
