...
* **Programming with Python**: October 6 & 8, 2025, 1 – 5 PM ET 
* **Unix command line and version control with Git**: October 15 & 17, 2025, 1 – 5 PM ET  
...
The next SCINet Corner will be held on August 28 2025, from 1 – 2 PM ET, and details about the presentation topic will be shared closer to the time of the event.  
