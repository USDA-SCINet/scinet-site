...
Applications are due by COB Monday, December 8, 2025.
...
Do you have large files on SCINet systems that you would like to share with external collaborators who don't have SCINet accounts? You will soon be able to do this using Globus, the same web-based interface recommended for other data transfers to, from, and among SCINet systems! 
