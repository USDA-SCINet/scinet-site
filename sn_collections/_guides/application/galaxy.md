...
![]({{ images_path }}/galaxy/keycloak/manage-ident.png)
6.	Further logins should only be done via keycloak. The legacy login will no longer work. 
![]({{ images_path }}/galaxy/keycloak/keycloak-login.png)
