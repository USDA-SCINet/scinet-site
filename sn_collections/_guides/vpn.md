...
If you have been using the SCINet VPN, please explore OOD for your use cases.  [Open OnDemand](/guides/use/open-ondemand) allows for full access to a Linux desktop, all SCINet apps, and cluster controls. 
