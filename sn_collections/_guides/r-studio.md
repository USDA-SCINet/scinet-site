...
In your browser go to [https://ceres-ood.scinet.usda.gov/](https://ceres-ood.scinet.usda.gov/) and log in using the [GUI login instructions](/guides/access/login#accessing-scinet-after-step-is-installed).
