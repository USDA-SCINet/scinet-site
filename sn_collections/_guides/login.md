...
1. Enter either of the following:
   A. ssh user.name@ceres.scinet.usda.gov (preferrably you should attempt your login on Ceres first)
...
![screenshot of Putty software]({{ site.baseurl }}/assets/img/guides/access/putty.png)
