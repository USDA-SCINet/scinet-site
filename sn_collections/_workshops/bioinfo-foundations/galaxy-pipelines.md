...
In this workshop, participants will work through a complete RNA-seq analysis and a variant calling workflow using SCINet’s Galaxy interface.<!--excerpt--> Participants will learn how to create workflows in Galaxy to:
...
* Build and run a variant calling pipeline for identifying genetic variants from sequencing data
