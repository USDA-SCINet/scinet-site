---
title: ARS SCINet and AI Center of Excellence Postdoctoral Fellowships Program (FY26)
...
All proposals must be submitted using the <!--[online submission form](https://forms.office.com/g/Gy1HHQ2mjN)--> online submission form (TBA). The PI's RL or supervisor must approve the proposal prior to submission (approval will be indicated on the submission form).

All proposals must use <!--[the fellowships proposal template](https://usdagcc.sharepoint.com/:w:/s/REE-ARS-SCINetOffice/Eb3IXP3pPedGn5ygXZ463m8BRkK_PDDyFMsSJ7G_fJRS7A?e=Jpkk0r)--> the fellowships proposal template (TBA). Please follow the instructions in the template and do not change the section headings or document formatting. The final proposal must be **no more than 750 words, including the headings**.
